...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-959-erd-s-problem-959-5535bb37-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-959"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-959-erd-s-problem-959-5535bb37-v1",
      "problem_contract_sha256": "e0b6c50dda90c89ed05a91fc19fc2b98960787b39785d36ad8a728a6eab6ae5e",
      "problem_id": "problem:um-ep-959-erd-s-problem-959-5535bb37",
      "route_id": "route:um-ep-959-erd-s-problem-959-5535bb37-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-959-erd-s-problem-959-5535bb37-source-fidelity-01",
      "graph_id": "graph:um-ep-959-erd-s-problem-959-5535bb37-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-959-erd-s-problem-959-5535bb37-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-959-erd-s-problem-959-5535bb37-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $A\\subset \\mathbb{R}^2$ be a set of size $n$ and let $\\{d_1,\\ldots,d_k\\}$ be the set of distinct distances determined by $A$. Let $f(d)$ be the number of times the distance $d$ is determined, and suppose the $d_i$ are ordered such that $ f(d_1)\\geq f(d_2)\\geq \\cdots \\geq f(d_k). $ Estimate $ \\max (f(d_1)-f(d_2)), $ where the maximum is taken over all $A$ of size $n$."
          },
          "statement_sha256": "cbaeabd6f1fc7d1d3c00d8897d297fb9ba966628c1a6d17156a2c2dc05986604"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-959-erd-s-problem-959-5535bb37-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-959-erd-s-problem-959-5535bb37-root",
      "route_id": "route:um-ep-959-erd-s-problem-959-5535bb37-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-959-6943c7db95f8",
        "url": "https://www.unsolvedmath.com/problems/EP-959"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
